    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            @can('currencies.index')
                <li class="nav-item">
                    <a href="{!! route('admin.currencies') !!}" class="nav-link {{ Request::is('settings/currencies*') ? 'selected' : '' }}" ><i class="nav-icon fa fa-dollar ml-1"></i> {{trans('lang.currency_plural')}}</a>
                </li>
            @endcan
            ...
            <li class="nav-item">
                <a href="{!! route('admin.settings.app.adminCommission') !!}" class="nav-link {{  Request::is('settings/app/adminCommission*') || Request::is('adminCommission*') ? 'selected' : '' }}">
                    <i class="fa fa-percent"></i> Admin Commission
                </a>
            </li>

            <li class="nav-item">
                <a href="{!! route('admin.settings.app.radiusConfiguration') !!}" class="nav-link {{  Request::is('settings/restaurantNearBy*') || Request::is('restaurantNearBy*') ? 'selected' : '' }}">
...
<div class="card {{ Request::is('settings/mobile*') ? '' : 'collapsed-card' }}">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item">
                <a href="{!! route('admin.settings.mobile.globals') !!}" class="nav-link {{  Request::is('settings/mobile/globals*') ? 'selected' : '' }}">
