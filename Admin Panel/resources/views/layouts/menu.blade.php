@php
$user = Auth::user();
$role_has_permission = json_decode(session('user_permissions', '[]'), true) ?? [];
@endphp
    ...
    <ul id="sidebarnav">
        ...
        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
            ...
            <ul aria-expanded="false" class="collapse">
                ...
                <li><a href="{!! url('payments') !!}">{{trans('lang.store_payments')}}</a></li>
                @endif

                @if(in_array('store-payouts', $role_has_permission))
                <li><a href="{!! url('storesPayouts') !!}">{{trans('lang.stores_payout_plural')}}</a></li>
                @endif
                ...
                <li><a href="{!! url('payoutRequests/stores') !!}">{{trans('lang.payout_request')}}</a></li>
                @endif
            </ul>
        ...
        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
            ...
            <ul aria-expanded="false" class="collapse">
                ...
                <li>
                    <a href="{!! url('settings/app/adminCommission') !!}">{{trans('lang.store_admin_commission')}}</a>
                </li>
                @endif
