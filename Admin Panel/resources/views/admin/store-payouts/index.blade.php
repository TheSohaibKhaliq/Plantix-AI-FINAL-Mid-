...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor restaurantTitle">{{trans('lang.stores_payout_plural')}}</h3>
                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link active" href="{!! url()->current() !!}"><i
                                        ...
                                        class="fa fa-list mr-2"></i>{{trans('lang.stores_payout_table')}}</a>
                            ...
                            <?php if ($id != '') { ?>
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="{!! route('admin.storesPayouts.create') !!}/{{$id}}"><i

                                            class="fa fa-plus mr-2"></i>{{trans('lang.stores_payout_create')}}</a>
                            ...
                            <?php } else { ?>
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="{!! route('admin.storesPayouts.create') !!}"><i
                            ...
                            <table id="storePayoutTable"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Admin {{trans('lang.stores_payout_note')}}</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const table = $('#storePayoutTable').DataTable({
