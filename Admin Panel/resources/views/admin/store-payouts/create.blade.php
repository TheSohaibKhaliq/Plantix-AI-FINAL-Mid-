    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{trans('lang.stores_payout_create')}}</li>
        ...
        <div class="row restaurant_payout_create">
            ...
            <div class="restaurant_payout_create-inner">
                ...
                <fieldset>
                    ...
                    <legend>{{trans('lang.stores_payout_create')}}</legend>
                    ...
                    <?php if ($id == '') { ?>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <label class="col-3 control-label">{{
                                ...
                                trans('lang.stores_payout_store')}}</label>
                            ...
                            <div class="col-7">
                                ...
                                <div class="form-text text-muted">
                                    ...
                                    {{ trans("lang.stores_payout_store_help") }}
                    ...
                    <div class="form-group row width-100">
                        ...
                        <label class="col-3 control-label">{{trans('lang.stores_payout_amount')}}</label>
                        ...
                        <div class="col-7">
                            ...
                            <div class="form-text text-muted">
                                ...
                                {{ trans("lang.stores_payout_amount_placeholder") }}
                    ...
                    <div class="form-group row width-100">
                        ...
                        <label class="col-3 control-label">{{ trans('lang.stores_payout_note')}}</label>
...
<script>
    ...
    $(".save-form-btn").click(async function () {
            ...
            if(vendorID == ''){
                ...
                $(".error_top").append("<p>{{trans('lang.store_vendor')}}</p>");
                ...
                $(".error_top").append("<p>{{trans('lang.store_valid_payment')}}</p>");
                ...
                $(".error_top").append("<p>{{trans('lang.store_note_error')}}</p>");
                 ...
                 var remaining = await remainingPrice(vendorID);
                    ...
                    if(remaining < amount){
                        ...
                        $(".error_top").show().html("<p>{{trans('lang.store_insufficient_payment_error')}}</p>");
