    ...
    <div class="row page-titles mb-4 pb-3 border-bottom align-items-center">
        <div class="col-md-5">
            <h3 class="text-dark fw-bold mb-0">
                <i class="fa fa-pencil-square-o text-success me-2" style="background: rgba(40, 167, 69, 0.1); padding: 12px; border-radius: 12px; width: 44px; text-align: center;"></i>
        ...
        <div class="col-md-7 text-end">
            <ol class="breadcrumb d-inline-flex bg-transparent p-0 m-0">
                ...
                <li class="breadcrumb-item active text-dark fw-semibold">{{trans('lang.edit_role')}}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-10 col-md-12">
                <div class="card border-0 shadow-sm" style="border-radius: 20px; overflow: hidden;">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-5">
                        ...
                        <p class="text-muted small mt-1">Review and update role permissions and identification name.</p>
                    </div>
                            ...
                            <div class="mb-5 bg-light p-5 rounded-4 border border-white shadow-sm">
                                <div class="row align-items-end">
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" class="form-control px-4 py-3 border-0 bg-white shadow-sm rounded-4" id="name" name="name" value="{{$roles->role_name}}" placeholder="Role name">
                                        <div class="form-text mt-2 ms-1 text-muted small">Update the role name to reflect its current responsibilities.</div>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="stores-edit"
                                                        ...
                                                        value="stores.edit" name="stores[]" class="permission"
                                                    ...
                                                    <input type="checkbox" id="stores-view"
                                                        ...
                                                        value="stores.view" name="stores[]" class="permission"
                                                    ...
                                                    <input type="checkbox" id="store-delete" value="store.delete"
                                                        ...
                                                        {{in_array('store.delete',$permissions) ? "checked" : "" }}

                                                        >

                                                        <label class=" control-label2" for="store-delete">{{trans('lang.delete')}}</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="store-payouts-list"
                                                        ...
                                                        class="permission" {{in_array('storesPayouts',$permissions)
                                                    ...
                                                    <input type="checkbox" id="store-payouts-create"
                                                        ...
                                                        value="storesPayouts.create" name="store-payouts[]"

                                                        class="permission"

                                                        {{in_array('storesPayouts.create',$permissions) ? "checked"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="payout-request-store"
                                                        ...
                                                        {{in_array('payoutRequests.stores',$permissions)
