                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-10">
                            <table id="taxTable"
                                ...
                                <thead>
                                <tr>
                                    <?php if (in_array('tax.delete', json_decode(@session('admin_permissions'),true))) { ?>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        if (checkDeletePermission) {
        html = html + '<a id="' + val.id + '" class="delete-btn" name="tax-delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
        }
        html = html + '</tr>';
        return html;
    }
