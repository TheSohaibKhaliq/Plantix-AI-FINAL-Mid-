                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="currenciesTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <?php if (in_array('currency.delete', json_decode(@session('admin_permissions'),true))) { ?>
                                        <th class="delete-all">
...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            if (checkDeletePermission) {
            html = html + '<a id="' + val.id + '" name="category-delete" class="delete-btn" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
            }
