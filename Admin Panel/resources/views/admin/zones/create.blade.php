    ...
    <div class="row page-titles mb-4 pb-3 border-bottom align-items-center">
        ...
        <div class="col-md-7 text-end">
            <ol class="breadcrumb d-inline-flex bg-transparent p-0 m-0">
                ...
                <li class="breadcrumb-item active text-dark fw-semibold">{{trans('lang.zone_create')}}</li>
            </ol>
        </div>
    </div>
    <!-- Main Content -->
            ...
            <div class="col-lg-10 col-md-12">
                <div class="card border-0 shadow-sm" style="border-radius: 20px; overflow: hidden;">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-5">
                        <h4 class="mb-0 fw-bold text-dark">{{trans('lang.zone_create')}}</h4>
                        <p class="text-muted small mt-1">Define geographic zones for your delivery system.</p>
                    </div>
                            ...
                            <div class="col-md-12 mb-5">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control px-4 py-3 border-0 bg-light rounded-4" id="name" placeholder="Enter zone name (e.g. Dubai Marina)">
