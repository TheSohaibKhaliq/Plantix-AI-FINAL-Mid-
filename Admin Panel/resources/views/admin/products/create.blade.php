...
<div class="container-fluid" style="padding-top: 24px; padding-bottom: 40px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 32px;">
        <div>
            ...
            <h1 style="font-size: 28px; font-weight: 700; color: var(--agri-primary-dark); margin: 0;">Add New Product</h1>
            <p style="color: var(--agri-text-muted); margin: 4px 0 0 0;">Add a new product to your catalog.</p>
        </div>
