    ...
    <div class="row page-titles mb-4 pb-3 border-bottom align-items-center">
        ...
        <div class="col-md-7 text-end">
            <ol class="breadcrumb d-inline-flex bg-transparent p-0 m-0">
                ...
                <li class="breadcrumb-item active text-dark fw-semibold">{{trans('lang.document_table')}}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm" style="border-radius: 20px; overflow: hidden;">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-5 d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-dark">{{trans('lang.document_table')}}</h4>
                            <p class="text-muted small mt-1">Manage and view all your system documents.</p>
                        </div>
                        <a href="{!! route('admin.documents.create') !!}" class="btn btn-success rounded-pill px-4 shadow-sm fw-bold">
                            <i class="fa fa-plus me-2"></i>{{trans('lang.document_create')}}
                        </a>
                    </div>
                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="documentTable"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <?php if (in_array('documents.delete', json_decode(@session('admin_permissions'), true))) { ?>
