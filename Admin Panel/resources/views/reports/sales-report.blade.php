    ...
    <script>
        ...
        async function getReportData(orderSnapshots, fileFormat) {
            ...
            await Promise.all(orderSnapshots.docs.map(async (order) => {
                ...
                finalOrderObject['Store Name'] = ((vendorData.title) ? vendorData.title : "");
        ...
        $(document).on('click', '.do-not-download', function () {
            ...
            var headerArray = ['Order ID', 'Store Name', 'Driver Name', 'Driver Email', 'Driver Phone', 'User Name', 'User Email', 'User Phone', 'Date', 'Category', 'Payment Method', 'Total', 'Admin Commission'];
