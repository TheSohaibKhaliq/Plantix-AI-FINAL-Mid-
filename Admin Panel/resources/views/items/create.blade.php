...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".save-form-btn").click(async function () {
            ...
            if (name == '') {
                ...
                checkDocumentVerify = await checkDocumentVerify(restaurant);

                if (checkDocumentVerify == true) {
                    ...
                    $(".error_top").append("<p>{{trans('lang.document_verification_pending_can_not_create_item')}}</p>");
    ...
    async function checkDocumentVerify(vendorId) {
