                                ...
                                <div class="resturant-detail mt-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white box-header">
                                            ...
                                            <h4 class="card-header-title">{{trans('lang.store')}}</h4>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            ref.get().then(async function (snapshots) {
                ...
                if (order.hasOwnProperty('estimatedTimeToPrepare') && order.estimatedTimeToPrepare != null) {
        ...
        function buildHTMLProductsList(snapshotsProducts) {
            ...
            snapshotsProducts.forEach((product) => {
                ...
                html = html + '<td class="text-green text-center"><span class="item-price">' + price_val + '</span><br><span class="base-price-'+product_id+' text-muted"></span></td><td> × ' + val.quantity + '</td><td class="text-green"> + ' + extras_price_val + '</td><td class="text-green">  ' + totalProductPrice_val + '</td>';
            ...
            database.collection('vendor_products').doc(product.id).get().then(async function (snapshots) {
                ...
                if(snapshots.exists){
                    ...
                    if (currencyAtRight) {
                        ...
                        base_price_format = parseFloat(base_price).toFixed(decimal_degits) + "" + currentCurrency;

                    } else {

                        base_price_format = currentCurrency + "" + parseFloat(base_price).toFixed(decimal_degits);
        ...
        function buildHTMLProductstotal(snapshotsProducts) {
                ...
                for (var i = 0; i < snapshotsProducts.taxSetting.length; i++) {
                    ...
                    if (!isNaN(tax) && tax != 0) {
                        ...
                        if (currencyAtRight) {
                            ...
                            html = html + '<tr><td class="label">' + taxlabel + " (" + taxvalue + taxlabeltype + ')</td><td class="tax_amount" id="greenColor">+' + parseFloat(tax).toFixed(decimal_degits) + '' + currentCurrency + '</td></tr>';

                        } else {

                            html = html + '<tr><td class="label">' + taxlabel + " (" + taxvalue + taxlabeltype + ')</td><td class="tax_amount" id="greenColor">+' + currentCurrency + parseFloat(tax).toFixed(decimal_degits) + '</td></tr>';
            ...
            html = html + '<tr class="grand-total"><td class="label">{{trans("lang.total_amount")}}</td><td class="total_price_val " id="greenColor">' + total_price_val + '</td></tr>';
                ...
                vendorOrder.products.forEach((productval) => {
                    ...
                    if (productval.id == val.productId) {
                        ...
                        if (productval.photo != '' && productval.photo !=null) {
                            ...
                            reviewhtml = reviewhtml + '<a href="javascript:void(0);"><img onerror="this.onerror=null;this.src=\'' + place_image + '\'" alt="#" src="' + productval.photo + '" class=" img-circle img-size-32 mr-2" style="width:60px;height:60px"></a>';
