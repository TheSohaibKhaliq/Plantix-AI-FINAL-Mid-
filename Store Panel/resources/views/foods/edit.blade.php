        ...
        <div>
            ...
            <div class="card-body">
                        ...
                        <fieldset>
                            ...
                            <div class="form-check width-100">
                                ...
                                <label class="col-3 control-label"
                                       ...
                                       for="food_take_away_option">{{trans('lang.item_take_away')}}</label>
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{{route('stores.items',$_GET['eid'])}}" class="btn btn-default"><i
                    ...
                    return function (e) {
                        ...
                        uploadTask.on('state_changed', function (snapshot) {
                            ...
                            uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                                ...
                                $(".item_image").append('<img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="rounded" style="width:50px" src="' + photo + '" alt="image">');
    ...
    function handleFileSelectProduct(evt) {
        ...
        reader.onload = (function (theFile) {
            ...
            return function (e) {
                ...
                photos_html = '<span class="image-item" id="photo_' + productImagesCount + '"><span class="remove-btn" data-id="' + productImagesCount + '" data-img="' + filePayload + '"><i class="fa fa-remove"></i></span><img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="rounded" width="50px" id="" height="auto" src="' + filePayload + '"></span>'
                    ...
                    if (item_attributeX) {
                        ...
                        if (variant_info[0]) {
                            ...
                            if (variant_info[0].variant_image) {
                                ...
                                variant_image = '<img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="rounded" style="width:50px" src="' + variant_info[0].variant_image + '" alt="image"><i class="mdi mdi-delete" data-variant="' + variant + '" data-status="old"></i>';
